...
async function addBonkAsset() {
  try {
    ...
    // Initialize program (using empty IDL for now)
    const program = new Program({}, LENDING_POOL_PROGRAM_ID, provider);
