...
const DynamicDepositContent = dynamic(
  () => Promise.resolve(DepositContentInner),
  {
    ssr: false,
  },
);
                ...
                {isCrossChain && (
                  <>
                    <div className="flex justify-between">
                      ...
                      <span>
                        {
                          CCIP_CONFIG[selectedChain as keyof typeof CCIP_CONFIG]
                            ?.name
                        }
                      </span>
                    </div>
